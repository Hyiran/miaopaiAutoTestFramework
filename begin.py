...
writeToLog(f,"点击拍摄按钮")
MonkeyRunner.sleep(2.0)
getPic(device,curdir,"unlogin",7)
writeToDetails(fi,"7、点击拍摄按钮弹出登陆界面截图")
...
writeToLog(f,"点击登录")
MonkeyRunner.sleep(2.0)
getPic(device,curdir,"unlogin",8)
writeToDetails(fi,"8、输入小于六位的密码截图")
...
writeToLog(f,"点击登录")
MonkeyRunner.sleep(2.0)
getPic(device,curdir,"unlogin",9)
writeToDetails(fi,"9、输入错误的密码截图")
device.press("KEYCODE_DEL","DOWN_AND_UP")
MonkeyRunner.sleep(0.3)
device.press("KEYCODE_DEL","DOWN_AND_UP")
MonkeyRunner.sleep(0.3)
...
getPic(device,curdir,"unlogin",10)
writeToDetails(fi,"10、首页截图")
